...
import { UserInfoDiv,ImageDiv, UserInfoTexts, UserName, OrgManager } from "../styledComponents/styles";
    ...
    <div>
      <DropDownDiv>
        <DropDownDivHead>
          ...
          <DivLines />
          <div><ViewAsFont>View as</ViewAsFont></div>
        </DropDownDivHead>
        <LayerTwo>
          <LoggenInProfileDiv>Logged-In Profile</LoggenInProfileDiv>
          <ImageInfoDiv >
            <UserInfoDiv style={{width:'45%', height:'100%',marginLeft:'10px'}} >
              <ImageDiv>
                <img src={userImg} alt="userimg"></img>
              </ImageDiv>
              <UserInfoTexts >
                <UserName style={{marginBottom:'4px'}}>Bessie Cooper</UserName>
        ...
        <LayerTwo style={{marginTop:'55px'}}>
          ...
          <SecondDropDown>
            <UserInfoDiv style={{width:'95%', height:'100%',marginLeft:'10px'}} >
        ...
        <div style={{borderTop: '1px solid #f0f2f4', display:'flex',alignItems:'center', justifyContent:'space-between', width:'100%', height:'60px', marginTop:'-15px'}}>
